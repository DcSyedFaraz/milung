                ...
                <div class="card  ">
                    <div class="card-header pt-3  ">
                        <div class="d-flex justify-content-between align-items-center mx-3">
                            ...
                            <div class="col-3">
                                <router-link :to="{ name: 'productEntry' }" class="btn btn-warning fw-bold text-dark">Add New
                                    Product</router-link>
                    ...
                    <div class="card-body rounded-top">
                        ...
                        <table class="table table-striped  display " id="">
                            ...
                            <tbody v-for="user in paginatedData" :key="user.articleNumber">
                                <tr>
                                    <td>{{ user.articleNumber }}</td>
                                    <td>{{ user.productName }}</td>
                                    <td>{{ user.description }}</td>
                                    <td>{{ user.productGroup }}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" @click="deleteUser(user.articleNumber)" class="text-dark"><i
                                                class="bi bi-trash"></i>
                                        </a>
                                    </td>
                                </tr>
                                <transition name="fade">
                                    <tr v-show="accordionOpen[user.articleNumber]">
                                        <td :colspan="7">
                                            <div>
