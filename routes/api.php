...
Route::middleware(['auth:sanctum', 'role:Admin|Internal'])->group(function () {
    ...
    Route::post('suppliers/{id}', [UserController::class, 'suppliersUpdate'])->middleware('can:addNewBuyerEntry,editBuyerEntry');
    ...
    Route::get('product/{id}', [ProductController::class, 'product'])->middleware('can:addProductEntry,editProductEntry');
